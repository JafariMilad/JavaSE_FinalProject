...
(
    ...
    constraint lesson_code FOREIGN KEY (lesson_code) references lessons (lesson_code),
...
(
    ...
    constraint teachers FOREIGN KEY (teachers) references teachers (teacher_code),
    registerDate date,
